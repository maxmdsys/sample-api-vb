...
**To run the sample project, you need to uncomment functions you want to use on [Main.vb](https://github.com/maxmdsys/sample-api-vb/tree/master/VBSampleCode/VBSampleCode/Main.vb) and [SendDirectMessagesSample.vb](https://github.com/maxmdsys/sample-api-vb/tree/master/VBSampleCode/VBSampleCode/SendDirectMessagesSample.vb) and set correct username and password.**
